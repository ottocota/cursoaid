...
Crie um documento do tipo nota técnica projeto de lei como restrito com a hipótese legal de documento preparatório. O nome da nota técnica deve ser NOTA TÉCNICA SEPLAG/SCPO em texto centralizado com negrito.
...
>Substitua os “xx” pelos textos armazenados correspondentes e não altere o restante do texto. Não altere o campo “xxCOMENTÁRIOS DAS TABELASxx”. Não entregue o resultado como um arquivo. Atente-se ao plural com base no número estabelecido no parâmetro “Órgãos e Siglas”: se for apenas um órgão retire o “(s)” do texto; se for mais de um órgão, utilize “s”, sem os parênteses.
